...
skip_story:
    std::cout << "이곳에서 펼쳐질 전투는, 포켓로그와 유사한 시스템으로 진행됩니다.\n";
    std::cout << "기본 공격과 고유 스킬을 전략적으로 사용하고, 아이템으로 체력을 회복하거나 공격력을 강화하며 몬스터들을 물리쳐야 합니다.\n";
    std::cout << "기본 공격 1회마다 마나를 1 획득합니다. 공격력을 올려주는 아이템인 힘의 알은 영구 적용입니다.";
    std::cout << "플레이어의 모든 아스키몬들이 기절한다면 각 스테이지의 휴식 스테이지로 돌아가고 모든 아스키몬들이 레벨업 합니다.\n";
    std::cout << "\n\n\n\n";
